...
//  * cameras in FRC. This library supports all Limelight features including AprilTag tracking,
// Neural
//  * Networks, and standard color/retroreflective tracking.
//  */
// public class LimelightHelpers {

//   private static final Map<String, DoubleArrayEntry> doubleArrayEntries = new
// ConcurrentHashMap<>();
...
// yaw
//    * components, ignoring z, roll, and pitch. Array format: [x, y, z, roll, pitch, yaw] where
// angles
//    * are in degrees.
//    *
//    * @param inData Array containing pose data [x, y, z, roll, pitch, yaw]
...
//   /**
//    * Gets the vertical offset from the principal pixel/point to the target in degrees. This is
// the
//    * most accurate 2d metric if you are using a calibrated camera and you don't need adjustable
//    * crosshair functionality.
//    *
...
//    *
//    * @param limelightName Name/identifier of the Limelight
//    * @return Pose3d object representing the robot's position and orientation in Red Alliance
// field
//    *     space
//    */
...
//    *
//    * @param limelightName Name/identifier of the Limelight
//    * @param alpha Defaults to .001. Higher values will cause the internal IMU to converge onto
// the
