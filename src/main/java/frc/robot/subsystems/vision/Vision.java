...
//           new Alert("Vision camera " + i + " (Limelight 4) is disconnected.",
// AlertType.kWarning);
//     }
...
//   /**
//    * Returns the distance to the nearest visible AprilTag in meters. Returns Double.NaN if no
// tags
//    * are visible.
//    */
...
//         // Calculate std devs — prefer LL-provided values, fall back to distance²/tagCount
// formula
//         double linearStdDev;
