...
//       new VisionInputsAutoLogged(); // DO NOT WORRY ABOUT RED ERRORS from this line and the
// inputs
...
//         0,
//         0,
//         0); // sets the robot orientation with the yaw. the pitch, roll, and rate are 0 because
// they
