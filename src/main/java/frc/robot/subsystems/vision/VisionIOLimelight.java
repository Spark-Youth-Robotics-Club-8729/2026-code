...
//  *
//  * <p>Uses LimelightHelpers for all NT communication. Runs both MegaTag1 (multi-tag, full 3D
// solve)
...
//   /**
//    * Call once when the robot transitions to enabled to switch the LL4 to internal+assist IMU
// mode.
//    */
...
//     inputs.rawFiducialDistances =
// rawDistances.stream().mapToDouble(Double::doubleValue).toArray();
//     inputs.tagCount = visibleTagIds.length;
//     inputs.avgTagDistance = visibleTagIds.length > 0 ? totalDist / visibleTagIds.length : 0.0;

//     // -----------------------------------------------------------------------
//     // Basic targeting data (tx/ty from crosshair — for servoing/auto-aim) -- this time, it
// ignore
//     // the blocked tags
//     // -----------------------------------------------------------------------
