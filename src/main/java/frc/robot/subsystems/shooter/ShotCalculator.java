...
//   // Interpolation maps
//   private static final InterpolatingDoubleTreeMap hoodAngleMap = new
...
//     latestParameters =
//         new ShootingParameters(isValid, hoodAngle, flywheelSpeed, finalDistance, tof,
// driveAngle);
...
//   // The equationss for flywheel speed, hood angle, and time of flight are based on empirical
// data
//   // and tuning. They can be adjusted as needed to better fit the actual performance of the
// robot.
...
//   /**
//    * Calculates shooting parameters directly from a vision-measured distance. Bypasses the
// lookahead
...
//     var params =
//         new ShootingParameters(isValid, hoodAngle, flywheelSpeed, distanceMeters, tof,
// driveAngle);
